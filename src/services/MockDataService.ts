import type { Patient, CalculationRecord, DashboardStats } from '@/types'
...
export const MOCK_HISTORY: CalculationRecord[] = [
  {
    id: 'h-001',
    type: 'dosage',
    patientId: 'p-001',
...
export class MockDataService {
  getRecentPatients(limit = 4): Patient[] {
    return MOCK_PATIENTS.slice(0, limit)
  }

  getRecentHistory(limit = 5): CalculationRecord[] {
