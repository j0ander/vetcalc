...
<header class="w-full top-0 sticky bg-surface dark:bg-surface shadow-sm flex justify-between items-center px-container-padding h-touch-target-min z-50 transition-colors duration-200">
  <div class="flex items-center gap-2">
    <span class="material-symbols-outlined text-primary dark:text-primary-fixed-dim animate-pulse-soft">pets</span>
...
<main class="px-container-padding pt-6 space-y-stack-lg pb-24">

  <!-- ===== BANNER CON IMAGEN ===== -->
  <section class="relative w-full rounded-2xl overflow-hidden shadow-elevated animate-fade-in-up group">
    <!-- Contenedor de la imagen (cambia el src por tu imagen) -->
    <img 
      src="https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=800&h=300&fit=crop" 
      alt="Veterinary clinic banner" 
      class="w-full h-40 md:h-56 object-cover transition-transform duration-700 group-hover:scale-105"
    />
    <!-- Superposición con gradiente y texto -->
  ...
  <!-- ===== SALUDO Y ESTADÍSTICAS (opcional) ===== -->
  ...
  <!-- ===== CUADRÍCULA DE MÓDULOS (con animación escalonada) ===== -->
  ...
  <!-- ===== CONSEJO DEL DÍA CON IMAGEN ===== -->
  <section class="w-full rounded-2xl overflow-hidden relative group shadow-elevated animate-fade-in-up" style="animation-delay: 450ms;">
    <!-- Contenedor de imagen (cambia el src por tu imagen) -->
    <img 
      alt="Consejo veterinario" 
      class="w-full h-48 object-cover transition-transform duration-700 group-hover:scale-105" 
      src="https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=800&h=300&fit=crop"
    />
